<h2><a href="https://leetcode.com/problems/integers-with-multiple-sum-of-two-cubes">3890. Integers With Multiple Sum of Two Cubes</a></h2><h3>Medium</h3><hr><p>You are given an integer <code>n</code>.</p>
